...
internal final class Helloworld_GreeterClient: GRPCClient, Helloworld_GreeterClientProtocol {
  ...
  internal func sayHello(_ request: Helloworld_HelloRequest, callOptions: CallOptions? = nil) -> UnaryCall<Helloworld_HelloRequest, Helloworld_HelloReply> {
...
extension Helloworld_GreeterProvider {
  internal var serviceName: String { return "helloworld.Greeter" }
